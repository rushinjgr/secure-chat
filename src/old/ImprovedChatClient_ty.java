...
public class ImprovedChatClient_ty extends JFrame implements Runnable, ActionListener {
    ...
    {
         ImprovedChatClient_ty JR = new ImprovedChatClient_ty();
