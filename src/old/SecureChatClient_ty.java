package old;/* @Programmer: Tyler Raborn
...
public class SecureChatClient_ty extends JFrame implements Runnable, ActionListener
{
    ...
    public SecureChatClient_ty()
    {
        try 
        {
            ...
            {
                cipher = new Substitute_ty(); //storing the resulting object in a SymCipher variable.
                System.out.println("\nSymmetric Encryption Scheme: Subsitute()");
            }
            else //or an Add128 object
            {
                cipher = new Add128_ty(); //storing the resulting object in a SymCipher variable.
    ...
    {
    SecureChatClient_ty JR = new SecureChatClient_ty();
