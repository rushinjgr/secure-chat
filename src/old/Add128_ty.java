...
public class Add128_ty implements SymCipher_ty
{
	//Add128 Fields:
	...
	public Add128_ty(byte[] byteArray) //The other constructor will use the byte array parameter as its key. The SecureChatClient will call the parameterless constructor and the SecureChatServer calls the version with a parameter.
	{
