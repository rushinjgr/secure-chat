...
public class Substitute_ty implements SymCipher_ty
{
	//Substitute Fields:
	...
	public Substitute_ty() //The parameterless constructor will create a random dim byte array which is a permutation of the dim possible byte values and will serve as a map from bytes to their substitution values.
	{		
	...
	public Substitute_ty(byte[] byteArray)
	{
