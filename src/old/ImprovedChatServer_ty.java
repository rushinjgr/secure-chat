package old;//for running with original client
...
public class ImprovedChatServer_ty
{
	...
	public ImprovedChatServer_ty(int MaxU)
	{
		MaxUsers = MaxU;
			...
			while (ok)
			{
				...
				try 
				{
					...
					if (newMsg == null || newMsg.equals("CLIENT CLOSING"))
						...
						ImprovedChatServer_ty.this.SendMsg(newMsg);
				}
				catch (IOException e)
				{
	...
	{
		ImprovedChatServer_ty JR = new ImprovedChatServer_ty(20);
	}
}
